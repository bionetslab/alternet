...
def read_grn_files(path, file_prefix, nruns):
    '''
    Read GRNBoost files from path and return a list of dataframes
    path: str, path to the folder where files are stored
    file_prefix: str, prefix of the files
    nruns: int, number of runs to read   
    '''
    grn_results = []
...
def aggregate_results(grn_results):
    ...
    grn_results: list of dataframes, results from multiple runs
    '''
